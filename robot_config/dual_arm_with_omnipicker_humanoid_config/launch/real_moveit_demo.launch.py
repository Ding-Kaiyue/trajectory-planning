...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("dual_arm_with_omnipicker_humanoid", package_name="dual_arm_with_omnipicker_humanoid_config").to_moveit_configs()
