...
domain::entities::Trajectory MoveLPlanningStrategy::plan(const geometry_msgs::msg::Pose& goal,
    ...
    switch (planning_type) {
        ...
        case PlanningType::CARTESIAN: {
            ...
            success = moveit_adapter_.planCartesianPath(waypoints, moveit_trajectory);
            if (!success) {
                RCLCPP_ERROR(rclcpp::get_logger("MoveLPlanningStrategy"),
