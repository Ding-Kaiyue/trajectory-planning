...
// ros2 topic pub --once /movej_goals sensor_msgs/msg/JointState "{position: [0.0, 0.5, -1.0, 1.2, 0.8, -0.3]}"
...
public:
    MoveJNode() : Node("movej_node") {
        ...
        RCLCPP_INFO(this->get_logger(), "MoveJ Node ready. Publish to /movej_goals");
    }
    ...
    void initializeComponents() {
        if (!motion_planning_service_) {
            ...
            RCLCPP_INFO(this->get_logger(), "MoveItAdapter, MoveJPlanningStrategy and TrajectoryExecutor initialized.");
        }
    }
