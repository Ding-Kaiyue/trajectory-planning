...
public:
    ...
    static domain::entities::Trajectory
    fromRosMessage(const trajectory_msgs::msg::JointTrajectory &msg);

    // 内部 Trajectory → ROS2 JointTrajectory
    static trajectory_msgs::msg::JointTrajectory
    toRosMessage(const trajectory_planning::domain::entities::Trajectory &trajectory,
                 const std::vector<std::string> &joint_names);
};

}  // namespace trajectory_planning_v3::infrastructure::adapters
